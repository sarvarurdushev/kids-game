  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-ink/60">🪙 {student.coinsBalance} coins</p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {shop.map((pack) => (
            <Card key={pack.id} className="flex flex-col items-center gap-2">
              <PackCard name={pack.name} subtitle={`${pack.cardsPerPack} cards`} />
              <p className="text-sm font-bold">🪙 {pack.coinCost}</p>
