  ...
  if (phase === "ready") {
    return (
      <div className="flex flex-col items-center gap-5 text-center">
        ...
        <div>
          <h1 className="font-display text-2xl font-bold text-gold-dark">Odd One Out</h1>
          <p className="mt-1 text-sm text-ink/60">
            Three pictures belong together — tap the one that doesn&apos;t!
          </p>
        </div>
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col items-center gap-1 rounded-3xl bg-white/80 py-3 shadow-sm">
        ...
        <p className="text-sm font-semibold text-ink/60">Which one doesn&apos;t belong?</p>
      </div>
      ...
      <AnimatePresence>
        {phase === "result" && (
          ...
          >
            {lastCorrect ? "Great job!" : `Not quite! The ${round.oddOne.word} didn't belong.`}
          </motion.p>
        )}
      </AnimatePresence>
    </div>
