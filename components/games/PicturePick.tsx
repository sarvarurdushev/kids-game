  ...
  if (phase === "ready") {
    return (
      <div className="flex flex-col items-center gap-5 text-center">
        ...
        <div>
          <h1 className="font-display text-2xl font-bold text-gold-dark">Picture Pick</h1>
          <p className="mt-1 text-sm text-ink/60">
            A word shows up — tap the picture that matches it!
          </p>
        </div>
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col items-center gap-2 rounded-3xl bg-white/80 py-4 shadow-sm">
        ...
        <p className="text-sm font-semibold text-ink/60">Which picture is this?</p>
      </div>
